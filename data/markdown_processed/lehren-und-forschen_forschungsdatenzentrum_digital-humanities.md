...
Die vielfältigen Quellen geisteswissenschaftlicher Forschung wie Texte, Bilder, Objekte, räumliche Daten und andere Untersuchungsobjekte eröffnen durch ihre digitale Erschließung, Analyse und Präsentation neue Perspektiven. Auf dieser Seite finden Sie allgemeine Informationen sowie Angebote der Universitätsbibliothek Mannheim für datenbezogene Forschungsprojekte.
...
- [forText](https://fortext.net/): Informationen, Grundlagenkurse und Anregungen zu Textauszeichnung, Topic Modelling und Visualisierung, mit Fokus auf Literaturwissenschaft
...
[TextGrid](https://textgrid.de/en/web/guest/home) (Angebot von CLARIAH-DE) ist eine virtuelle Forschungsumgebung, die mit verschiedenen Werkzeugen den gesamten Forschungsprozess unterstützt. Das [TextGrid Repository](https://textgridrep.org/) dient als Langzeitarchiv für geisteswissenschaftliche Forschungsdaten und bietet eine digitale Bibliothek mit zahlreichen XML/TEI-erschlossenen Texten in deutscher Sprache seit dem Anfang des Buchdrucks.
...
In den Digital Humanities gibt es zahlreiche Initiativen für offene Publikationsinfrastrukturen.

### Zeitschriften

- [Zeitschrift für digitale Geisteswissenschaften (ZfDG)](https://zfdg.de/): Diamond Open Access Journal für Digital Humanities
- [Digital Humanities Quarterly](http://www.digitalhumanities.org/dhq/): Herausgegeben von ADHO und der Association for Computers and the Humanities
- [Digital Studies / Le champ numérique](https://www.digitalstudies.org/): Von der ADHO
- [Open Library of Humanities](https://www.openlibhums.org/journals/): Plattform für Diamond Open Access Journals in den Digital Humanities mit unterschiedlichen thematischen Schwerpunkten
...
Die Universitätsbibliothek Mannheim bietet vielfältige Services und individuelle Unterstützung bei Digital Humanities-Projekten – etwa bei der Erstellung von Korpora, der Text- und Spracherkennung sowie beim Management von Forschungsdaten während des gesamten Forschungszyklus.
