...
category: Medien
tags: ['Medien- und Kommunikationswissenschaft', 'Fachinformation', 'Datenbanken', 'E-Books', 'E-Journals', 'Schulungen', 'Literaturstandorte', 'Publikationsservices']
language: de
---
...
- [Datenbanken zur Medien- und Kommunikationswissenschaft](https://dbis.ur.de/UBMAN/browse/subjects/25/) im Datenbank-Infosystem (DBIS)
...
- E-Journals für Medien- und Kommunikationswissenschaft in der [Elektronischen Zeitschriftenbibliothek (EZB)](http://rzblx1.uni-regensburg.de/ezeit/fl.phtml?bibid=UBMAN&colors=7&lang=de%C2%ACation=AP)
...
- Umfangreiches E-Book-Angebot im [Katalog Primo](https://primo.bib.uni-mannheim.de/primo-explore/search?vid=MAN_UB), zugänglich im Netz der Universität Mannheim
...
- [Bibliotheksbereich A3](https://www.bib.uni-mannheim.de/standorte/bb-a3/): Literatur zum Fach Medien- und Kommunikationswissenschaften, vor Ort nutzbar, frei zugänglich und nach [Themengebieten](https://rvk.uni-regensburg.de/regensburger-verbundklassifikation-online) aufgestellt. Ausleihen nur für wissenschaftliches Personal der Universität Mannheim.
...
- [Kurs für MKW-Studierende vor dem Examen](https://ilias.uni-mannheim.de/ilias.php?baseClass=ilrepositorygui&cmd=view&ref_id=1220603)
