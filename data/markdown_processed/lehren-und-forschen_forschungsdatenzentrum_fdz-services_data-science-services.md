...
tags: [Data Science, Research, Services]
language: de
```

# Data Science Services

Die [Data Science Services](https://www.bib.uni-mannheim.de/lehren-und-forschen/forschungsdatenzentrum/fdz-services/data-science-services/) der Universität Mannheim bieten umfassende Unterstützung für Forschungsprojekte. Hier sind die Hauptangebote zusammengefasst.
...
- Beratung zu No-Code-Tools (Google Cloud Auto ML, ML KIT, Runway AI, Lobe, CreateML, RapidMiner, DataRobot).
...
- Informationen zum [Mannheim Center for Data Science](https://www.uni-mannheim.de/datascience).
