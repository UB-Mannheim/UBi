...
category: Benutzung
tags: ['Bibliotheksausweis', 'Privatpersonen', 'Anmeldung', 'UB-Chipkarte', 'Gebühren', 'InfoCenter', 'Metropolregion Rhein-Neckar', 'Ersatzkarte']
language: de
---
...
Personen, die in der Metropolregion Rhein-Neckar oder in Baden-Württemberg wohnen, arbeiten oder studieren, können für eine einmalige Gebühr von 25 Euro die UB-Chipkarte online beantragen.

Mit der UB-Chipkarte und den Zugangsdaten (Uni-ID und Passwort) können Sie:
...
**Hinweis:** Internetnutzung und WLAN sind nur für Angehörige der Universität möglich. Die Lernräume der UB können ohne Bibliotheksausweis genutzt werden.
